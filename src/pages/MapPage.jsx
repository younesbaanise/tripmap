          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex-1">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-[#2D2D34]">Travel Map</h1>
                  <p className="text-lg text-[#6B6B70]">Explore your adventures around the world</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-[#F6F5F3] rounded-xl p-4 border border-[#DADADA] hover:shadow-md transition-all duration-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-[#2D2D34]">{tripsWithCoordinates.length}</p>
                ...
                <div className="bg-[#F6F5F3] rounded-xl p-4 border border-[#DADADA] hover:shadow-md transition-all duration-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-[#2D2D34]">{trips.filter(t => t.status === 'Future Trip' && t.lat && t.lng).length}</p>
                ...
                <div className="bg-[#F6F5F3] rounded-xl p-4 border border-[#DADADA] hover:shadow-md transition-all duration-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-[#2D2D34]">{trips.filter(t => t.status === 'Visited' && t.lat && t.lng).length}</p>
                      <p className="text-sm text-[#6B6B70]">Completed</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {tripsWithCoordinates.length > 0 && (
            <div className="p-6 border-b border-[#DADADA] bg-gradient-to-r from-[#F6F5F3] to-white">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#2D2D34]">Map Legend</h3>
              </div>
              <div className="flex flex-wrap gap-6 text-sm">
                <div className="flex items-center space-x-3">
                  <div className="w-5 h-5 bg-[#00BFA6] rounded-full border-2 border-white shadow-md"></div>
                  <span className="text-[#2D2D34] font-medium">Visited Trips</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-5 h-5 bg-[#8E6DE9] rounded-full border-2 border-white shadow-md"></div>
                  <span className="text-[#2D2D34] font-medium">Future Trips</span>
                </div>
              </div>
            </div>
          )}
                ...
                >
                  <Popup className="trip-popup">
                    <div className="min-w-[250px] max-w-[300px] p-2">
                      ...
                      {/* Trip Title */}
                      <h3 className="font-bold text-sm text-[#2D2D34] mb-3 text-center">
                        {trip.placeName}
                      </h3>
                      ...
                      {/* Trip Dates */}
                      <div className="text-xs text-[#6B6B70] text-center mb-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center space-x-2 bg-[#8E6DE9] text-white py-2 px-3 rounded-lg text-xs font-medium hover:bg-[#8E6DE9]/90 transition-all duration-200 cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center space-x-2 bg-[#00BFA6] text-white py-2 px-3 rounded-lg text-xs font-medium hover:bg-[#00BFA6]/90 transition-all duration-200 cursor-pointer"
                        >

    ...
    <div className="min-h-screen bg-[#F6F5F3]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#00BFA6] to-[#8E6DE9] rounded-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[#2D2D34] mb-3">My Travel Adventures</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
            <div className="bg-white rounded-lg p-4 shadow-sm border border-[#DADADA]">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-2xl font-bold text-[#2D2D34]">{trips.length}</span>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border border-[#DADADA]">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-2xl font-bold text-[#2D2D34]">{getStatusCount('Future Trip')}</span>
              </div>
              <p className="text-sm text-[#6B6B70]">Planned</p>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm border border-[#DADADA]">
              <div className="flex items-center justify-center space-x-2">
                <FaGlobeAmericas className="w-5 h-5 text-[#FF5E5B]" />
                <span className="text-2xl font-bold text-[#2D2D34]">{getStatusCount('Visited')}</span>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border border-[#DADADA]">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-[#2D2D34]">Filter by Status</h3>
            </div>
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-lg border border-[#DADADA]">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-[#2D2D34] mb-3">
                {statusFilter === 'all' ? 'No adventures yet' : `No ${statusFilter.toLowerCase()} adventures`}
              </h3>

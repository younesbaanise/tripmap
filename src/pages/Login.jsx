        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-[#2D2D34] mb-2">Welcome Back</h1>
              <p className="text-[#6B6B70]">Ready to continue your travel journey?</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="text-right">
                <button
                  ...
                  className="text-sm text-[#00BFA6] hover:text-[#00BFA6]/80 transition-colors"
                >
              ...
              <div className="text-center">
                <p className="text-sm text-[#6B6B70]">
                  ...
                  <button
                    ...
                    className="font-medium text-[#00BFA6] hover:text-[#00BFA6]/80 transition-colors"
                  >
                    Sign up here
                  </button>
                </p>
